...
def test_t17001():
    ps1 = T17001()
    print(ps1.run(user_name='仲小梅', id_card_no='321284198501083626', phone='15052304168'))


    # ps2 = T17001()
    # ps2.run('丁炎滨', '370983199111010012', '13761955305')
    ...
    # ps3 = T17001()
    # ps3.run('万国梁', '360123198508011930', '18516326459')
    ...
    #
    # ps5 = T17001()
    # ps5.run('何淼君', '332621197205058252', '13117174542')
    ...
    #
    # ps6 = T17001()
    # ps6.run('余瑞泉', '350623198102251016', '13817853005')
