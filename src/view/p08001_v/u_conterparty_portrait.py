...
class u_counterparty_portrait(TransFlow):

    def read_u_counterparty_pt_process(self):
        ...
        df = self.cached_data['trans_u_counterparty_portrait']
        ...
        self.variables['trans_u_counterparty_portrait'] = "{\"income_amt_order\":{" + json_1 + \
