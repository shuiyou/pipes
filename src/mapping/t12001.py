...
class T12001(Transformer):
    ...
    def _info_anti_fraud_rule(self):
        sql = '''
            ...
            FROM info_anti_fraud_rule LEFT JOIN info_anti_fraud_strategy ON info_anti_fraud_rule.anti_fraud_rule_id = info_anti_fraud_strategy.anti_fraud_rule_id
            WHERE info_anti_fraud_strategy.anti_fraud_id IN (
                SELECT af.anti_fraud_id FROM (
                    SELECT anti_fraud_id FROM info_anti_fraud 
