...
class Transformer(object):
    ...
    def run(self, user_name=None, id_card_no=None, phone=None, user_type=None, base_type=None, origin_data=None, cached_data=None, strategy=None) -> dict:
        self.input(id_card_no, phone, user_name, user_type, base_type, origin_data, cached_data, strategy)
        self.transform()
        return {
    ...
    def input(self, id_card_no, phone, user_name, user_type=None, base_type=None, origin_data=None, cached_data=None, strategy=None):
